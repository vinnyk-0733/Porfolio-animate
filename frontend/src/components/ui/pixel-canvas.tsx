...
// Fallback for Next.js SSR window isolation
const BaseElement = (typeof window !== "undefined" ? window.HTMLElement : Object) as unknown as typeof HTMLElement;

class PixelCanvasElement extends BaseElement {
